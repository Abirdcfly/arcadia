...
fileUploadSummarise "base-chat-document-assistant" "arcadia" "./pkg/documentloaders/testdata/tenxcloud.pdf"
getRespInAppChat "base-chat-document-assistant" "arcadia" "时速云是什么？" ${resp_conversation_id} "false"
