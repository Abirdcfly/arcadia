...
func (in *Node) DeepCopyInto(out *Node) {
	*out = *in
	if in.LLMRef != nil {
		in, out := &in.LLMRef, &out.LLMRef
		*out = new(TypedObjectReference)
		(*in).DeepCopyInto(*out)
	}
	if in.LLMSpec != nil {
		in, out := &in.LLMSpec, &out.LLMSpec
		*out = new(LLMSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.EmbedderRef != nil {
		in, out := &in.EmbedderRef, &out.EmbedderRef
		*out = new(TypedObjectReference)
		(*in).DeepCopyInto(*out)
	}
	if in.EmbedderSpec != nil {
		in, out := &in.EmbedderSpec, &out.EmbedderSpec
		*out = new(EmbedderSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.VectorStoreRef != nil {
		in, out := &in.VectorStoreRef, &out.VectorStoreRef
		*out = new(TypedObjectReference)
		(*in).DeepCopyInto(*out)
	}
	if in.VectorStoreSpec != nil {
		in, out := &in.VectorStoreSpec, &out.VectorStoreSpec
