...
type VectorStoreSpec struct {
	...
	// another field is like pv, https://github.com/kubernetes/kubernetes/blob/a8a1abc25cad87333840cd7d54be2efaf31a3177/staging/src/k8s.io/api/core/v1/types.go#L49
	//Chrome *ChromeSource `json:"chrome,omitempty"`
